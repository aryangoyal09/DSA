...
/*
If an array has n elements and all elements are inserted in binary search tree,
Then the tree has space complexity of O(n) and the array also has the space complexity of O(n)
*/
